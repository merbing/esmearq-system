...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try{
        ...
        ($senha==null || $senha=="") || ($confirm==null || $confirm=="") || ($telefone==null || $telefone=="")){
        ...
        $query = "INSERT INTO freelancers (nome,telefone,email,senha) values('$name','$telefone','$email','$password');";
...
<head>
    ...
    <title>Criar Conta - Esmearq Freelancers</title>
                    ...
                    <div class="materialContainer">
                        <div class="box">
                            <div class="login-title">
                                <h3 class="mb-2">Área de Freelancer</h3>
