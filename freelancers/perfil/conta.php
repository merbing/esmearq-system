<?php 
      session_start();
        ...
        try{
            ...
            $query = "SELECT * FROM freelancers  WHERE id = '$user_id' ";
                           ...
                           ?>
                                ...
                                <form method="POST" action="processar/conta/editar/basico.php">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nome" id="nome" value="<?=$freelancer['nome']??$user_name??'Indisponível'?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">E-mail</label>
                                        <input type="email" class="form-control" name="email" id="email" value="<?=$freelancer['email']??$user_email??'Indisponível'?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="telefone">Telefone</label>
                                        <input type="tel" class="form-control" name="telefone" id="telefone" value="<?=$freelancer['telefone']??$user_phone??'Indisponível'?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="nif">Nif</label>
                                        <input type="text" class="form-control" name="nif" id="nif" value="<?=$freelancer['nif']??$user_nif??'Indisponível'?>">
                                    </div>
