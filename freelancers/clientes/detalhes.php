        ...
        <div class="main-content app-content">
            ...
            <div class="container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            <h4 class="content-title mb-0 my-auto">Detalhes do Cliente</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <?php
                           ...
                           ?>
                                ...
                                <p>ID: <span style="font-weight:bold"><?=$cliente['id']??'Não disponível'?></span></p>
                                <p>Nome: <span style="font-weight:bold"><?=$cliente['nome']?></span></p>
                                <p>Email:  <span style="font-weight:bold"><?=$cliente['email']?></span></p>
                                <p>Telefone: <span style="font-weight:bold;text-transform:uppercase"><?=$cliente['telefone']?></span></p>
                                <p>NIF: <span style="font-weight:bold;text-transform:uppercase"><?=$cliente['nif']?></span></p>
                                <p>Data de Nascimento: <span style="font-weight:bold;text-transform:uppercase"><?=$cliente['data_de_nascimento']?></span></p>
                                <p>Endereço: <span style="font-weight:bold;text-transform:uppercase"><?=$cliente['endereco']?></span></p>
