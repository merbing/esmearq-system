                     ...
                     <div class="col-md-12 m-b-30">
                        ...
                        <div class="d-block d-sm-flex flex-nowrap align-items-center">
                           <div class="page-title mb-2 mb-sm-0">
                              <h1>Lista de Estados dos processos</h1>
                           </div>
                           <div class="ml-auto d-flex align-items-center">
                              <nav>
                                 <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Estado dos processos</li>
                                 </ol>
                              </nav>
                           </div>
                        ...
                        <div class="mt-3">
                           <a href="adicionar_estado.php" class="btn btn-sm btn-success">Adicionar</a>
                        </div>
                        <!-- end page title -->
                     </div>
                  </div>
                                 ...
                                 <table id="datatable" class="display compact table table-striped table-bordered">
                                    ...
                                    <?php foreach($states as $item): ?>
                                       <tr>
                                          ...
                                          <td style="text-transform: uppercase;"><?php echo $item['nome_estado'] ?></td>
                                          <td>
