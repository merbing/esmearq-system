                                    ...
                                    <div class="card card-statistics">
                                       <div class="card-header">
                                          <div class="card-heading">
                                             <h4 class="card-title">Adicionar Novo Ponto</h4>
                                          </div>
                                       </div>
                                       <div class="card-body">
                                          <div class="tab">
                                             <form action="processar/agencia/adicionar.php" method="post" class="form-horizontal">
                                                <div class="form-group">
                                                   <label for="nome_agencia">Nome do Agência</label>
                                                   <input type="text" class="form-control" id="nome_agencia" name="nome_agencia" placeholder="Nome da Agência" required />
                                                </div>
                                                <div class="form-group">
