                                                ...
                                                <div class="tab-pane fade active show py-3" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                   <form action="processar/agendamentos/adicionar/iniciar.php" method="post" class="form-horizontal">
                                                      ...
                                                      <div class="form-group" id="razoes_nao_aprovado" style="display: none;">
                                                         ...
                                                         <div class="mb-2">
                                                            <input type="text" class="form-control" id="razoes_nao_aprovado_input" name="razoes_nao_aprovado_input" placeholder="Digite as razões" />
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group" id="ano_nao_aprovado" style="display: none;">
                                                         ...
                                                         <div class="mb-2">
                                                            <input type="text" class="form-control" id="ano_nao_aprovado_input" name="ano_nao_aprovado_input" placeholder="Digite o ano" />
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group" id="quantidade_nao_aprovado" style="display: none;">
                                                         ...
                                                         <div class="mb-2">
                                                            <input type="number" class="form-control" id="quantidade_nao_aprovado_input" name="quantidade_nao_aprovado_input" placeholder="Digite a quantidade" />
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group" id="ano_visto_aprovado" style="display: none;">
                                                         ...
                                                         <div class="mb-2">
                                                            <input type="text" class="form-control" id="vinheta" name="vinheta" placeholder="Digite o ano da vinheta do visto" />
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group" id="info_familiar" style="display: none;">
                                                         ...
                                                         <div class="mb-2">
                                                            <input type="number" class="form-control" id="qtd_familia" name="qtd_familia" placeholder="Digite a quantidade de pessoas" />
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group" id="info_outra_pessoa" style="display: none;">
                                                         ...
                                                         <div class="mb-2">
                                                            <input type="text" class="form-control" id="nome_outra_pessoa" name="nome_outra_pessoa" placeholder="Nome" />
                                                            <input type="text" class="form-control" id="numero_outra_pessoa" name="numero_outra_pessoa" placeholder="Número de telefone" />
                                                            <input type="text" class="form-control" id="endereco_outra_pessoa" name="endereco_outra_pessoa" placeholder="Endereço" />
                                                            <input type="text" class="form-control" id="emprego_outra_pessoa" name="emprego_outra_pessoa" placeholder="Emprego" />
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group">
                                                         ...
                                                         <div class="mb-2">
                                                            <select class="form-control" name="trabalho" id="trabalho" required>
                                                               <option selected disabled>Selecionar</option>
                                                               <option value="Por Conta Própria">Por Conta Própria</option>
                                                               <option value="Empresa">Empresa e função</option>
                                                      ...
                                                      <div class="form-group">
                                                         ...
                                                         <div class="mb-2">
                                                            <input type="text" class="form-control" id="recomendacao" name="recomendacao" placeholder="Digite sua recomendação, se houver" />
                                                         </div>
                                                      </div>
                                                      <div class="form-group">
