                           ...
                           <div class="ml-auto d-flex align-items-center">
                              <nav>
                                 <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Lista de Créditos</li>
                                 </ol>
                              </nav>
                           </div>
                        </div>
                           ...
                           <div class="card-body">
                              <div class="datatable-wrapper table-responsive">
                                 <?php
                                    ...
                                    // Consulta SQL para obter dados relevantes das tabelas com base nos critérios de pesquisa
                                    $sql = "SELECT * FROM submissao_credito
                                            WHERE id_submissao LIKE '%$termo_pesquisa%'
                                            OR id_cliente LIKE '%$termo_pesquisa%'";
