                     ...
                     <div class="col-md-12 m-b-30">
                        ...
                        <div class="d-block d-sm-flex flex-nowrap align-items-center">
                           <div class="page-title mb-2 mb-sm-0">
                              <h1>Lista de Créditos Pendentes</h1>
                           </div>
                           <div class="ml-auto d-flex align-items-center">
                              <nav>
                                 <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Lista de Créditos Pendentes</li>
                                 </ol>
                              </nav>
                           </div>
                        </div>
                                 ...
                                 <?php
                                    ...
                                    if($cargo_id == 1 || 0){
                                       $sql = "SELECT * FROM submissao_credito
                                             WHERE status = 'pendente' AND id_agencia = '$agencia_id' ORDER BY id_submissao DESC";}
                                    else {
                                       $sql = "SELECT * FROM submissao_credito
