                        ...
                        <div class="card card-statistics">
                              ...
                              <?php
                                 if ($resultEntregaCredito->num_rows > 0) {
                                     while ($row = $resultEntregaCredito->fetch_assoc()) {
                                       ...
                                       <button class="btn btn-warning" type="submit">Gerar Contrato</button>
                           ...
                           <div class="card-body">
                              ...
                              <?php
                                 ...
                                 ?>
                              <a href="historico.php?credito_selecionado=<?php echo $id_submissao?>" class="btn btn-dark">Histórico de Pagamentos</a>
