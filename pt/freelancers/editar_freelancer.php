                        ...
                        <div class="card card-statistics">
                           <div class="card-header">
                              <div class="card-heading">
                                 <h4 class="card-title">Editar dados do Freelancer <span class="text-info"><?=$freelancer['nome']?></span> </h4>
                              </div>
                           </div>
                           <div class="card-body">
                           <form action="processar/freelancers/editar_info/basicas.php" method="post" class="form-horizontal">
                                 ...
                                 <input type="hidden" name="id_freelancer" value="<?=$freelancer['id']?>" ><div class="form-group">
                                    <label class="control-label" for="nome">Nome Completo*</label>
                                    <div class="mb-2">
                                       <input type="text" class="form-control" id="nome"value="<?=$freelancer['nome']?>" name="nome" placeholder="Nome" required />
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="mb-2">
                                       <input type="text" value="<?=$freelancer['telefone']?>" class="form-control" id="Telefone" name="telefone" placeholder="Telefone" required />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label" for="uemail">Email*</label>
                                    <div class="mb-2">
                                       <input type="email" value="<?=$freelancer['email']?>" class="form-control" id="uemail" name="email" placeholder="Email" required />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label" for="uemail">NIF*</label>
                                    <div class="mb-2">
                                       <input type="text" value="<?=$freelancer['nif']?>" class="form-control" id="uemail" name="nif" placeholder="NIF" required />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label" for="uemail">BANCO*</label>
                                    <div class="mb-2">
                                       <input type="text" value="<?=$freelancer['banco']?>" class="form-control" id="uemail" name="banco" placeholder="BANCO" required />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label" for="uemail">NUMERO DA CONTA*</label>
                                    <div class="mb-2">
                                       <input type="number" value="<?=$freelancer['numero_da_conta']?>" class="form-control" id="uemail" name="numero" placeholder="Numero da conta" required />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label" for="uemail">IBAN*</label>
                                    <div class="mb-2">
                                       <input type="text" value="<?=$freelancer['iban']?>" class="form-control" id="uemail" name="iban" placeholder="IBAN" required />
                                    </div>
                                 </div>
                                 <div class="form-group">
