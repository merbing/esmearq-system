...
<html lang="pt">
   <head>
      <?php 
         ...
         include("consultas/freelancers/clientes.php");
                     ...
                     <div class="col-md-12 m-b-30">
                        ...
                        <div class="d-block d-sm-flex flex-nowrap align-items-center">
                           <div class="page-title mb-2 mb-sm-0">
                              <h1>Clientes do Freelancer - <span class="text-info"><?=$freelancer['nome']?></span> </h1>
                           </div>
                           <div class="ml-auto d-flex align-items-center">
                              <nav>
                                 <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Clientes </li>
                                 </ol>
                              </nav>
                           </div>
                        </div>
                        <div class="mt-3">
                           <a href="adicionar_cliente.php?freelancer_id=<?=base64_encode($freelancer['id'])?>" class="btn btn-sm btn-info">Adicionar</a>
                        </div>
                        <!-- end page title -->
                     </div>
                  </div>
                                 ...
                                 <table id="datatable" class="display compact table table-striped table-bordered">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td><?php echo $item['data_de_nascimento'] ?></td>
                                          <td><?php echo $item['telefone'] ?></td>
                                          <td><?php echo $item['processos']??0 ?></td>
                                          <!-- <td> -->
