                     ...
                     <div class="col-md-12 m-b-30">
                        ...
                        <div class="d-block d-sm-flex flex-nowrap align-items-center">
                           <div class="page-title mb-2 mb-sm-0">
                              <h1>Lista de Serviços Solicitados</h1>
                           </div>
                                 ...
                                 <table id="datatable" class="display compact table table-striped table-bordered">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td><?php echo $item['estado']==1?"SIM":"NÃO" ?></td>
                                          <td>
                                             ...
                                             <a role="button" data-toggle="modal" data-target="#ModalNotify<?=$item['id']?>" class="btn  btn-dark text-light btn-sm">Concluir</a>
                                             <!-- MODAL -->
                                               ...
                                               <div class="modal-dialog">
                                                   <div class="modal-content">
                                                    <div class="modal-header">
                                                         <h5 class="modal-title">Concluir Solicitação de Serviço</h5>
                                                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                         </button>
                                                      </div>
                                                      <div class="modal-body">
                                                            <p class="text-dark mb-3" style="font-size: 1.4em;">Deseja definir esta solicitação como concluída?</p>
                                                            
                                                      </div>
                                                      <div class="modal-footer">
                                                      <a  class="btn btn-info text-light" href="concluir_servico.php?solicitacao_id=<?=base64_encode($item['id']);?>" >Sim</a>   
