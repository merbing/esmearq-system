                        ...
                        <div class="card card-statistics">
                           <div class="card-header">
                              <div class="card-heading">
                                 <h4 class="card-title">Cadastrar Viagem</h4>
                              </div>
                           </div>
                           <div class="card-body">
                              <form action="processar/viagens/adicionar/basico.php" method="post" class="form-horizontal">
                                 ...
                                 <div class="col-4 form-group">
                                    ...
                                    <div class="mb-2">
                                       <input type="time" class="form-control" id="time" name="time" placeholder="Data" required />
                                    </div>
                                 </div>
                                 <div class="col-4 form-group">
                                    <label class="control-label" for="horario">Destino</label>
                                    <div class="mb-2">
                                       <input type="text" class="form-control" id="destino" name="destino" placeholder="Destino da viagem" required />
                                    </div>
                                 </div>
